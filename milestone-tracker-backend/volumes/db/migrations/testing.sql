...
INSERT INTO public.proposals (id, title, url, project_id, completion_date, created_at, challenge_id, budget) VALUES
  ...
  (2, 'Proposal 2', 'https://cardano.ideascale.com/a/dtd/419167-48088', 900003,	'2023-06-30 00:00:00', '2022-11-10 16:35:28.580163+00', 2, 100000),
...
INSERT INTO public.soms (outputs, success_criteria, evidence, month, cost, completion, proposal_id, milestone, title, challenge_id, user_id, current)
  VALUES
    ...
    ('Lorem ipsum dolor sit amet', 'Lorem ipsum dolor sit amet', 'Lorem ipsum dolor sit amet', '3', 20000, 30, 2, 1, 'Title ipsum', 2, (SELECT user_id FROM public.users WHERE email = 'proposer-2@example.org' LIMIT 1), false),
    ('Lorem ipsum dolor sit amet', 'Lorem ipsum dolor sit amet', 'Lorem ipsum dolor sit amet', '3', 20000, 30, 2, 1, 'Title ipsum 2 try', 2, (SELECT user_id FROM public.users WHERE email = 'proposer-2@example.org' LIMIT 1), true),
    ('Lorem ipsum dolor sit amet', 'Lorem ipsum dolor sit amet', 'Lorem ipsum dolor sit amet', '3', 20000, 30, 2, 2, 'Title ipsum 2', 2, (SELECT user_id FROM public.users WHERE email = 'proposer-2@example.org' LIMIT 1), true),
    ('Lorem ipsum dolor sit amet', 'Lorem ipsum dolor sit amet', 'Lorem ipsum dolor sit amet', '3', 20000, 30, 2, 3, 'Title ipsum 3', 2, (SELECT user_id FROM public.users WHERE email = 'proposer-2@example.org' LIMIT 1), true),
...
INSERT INTO public.signoffs (som_id, user_id)
  VALUES
    ...
    (8, (SELECT user_id FROM public.users WHERE email = 'signoff@example.org' LIMIT 1)),
    (9, (SELECT user_id FROM public.users WHERE email = 'signoff@example.org' LIMIT 1)),
    (10, (SELECT user_id FROM public.users WHERE email = 'signoff@example.org' LIMIT 1));

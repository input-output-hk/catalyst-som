export default {
  ...
  new_som_review: {
    ...
    outputs_approved_help: "Please select whether the \"Outputs\" of the Milestone are approved or not approved.",
    ...
    success_criteria_approved_help: "Please select whether the \"Acceptance Criteria\" of the Milestone are approved or not approved.",
    ...
    evidence_approved_help: "Please select whether the \"Evidence of milestone completion\" of the Milestone are approved or not approved.",
    ...
    approval_option_approved: "Approved",
    approval_option_not_approved: "Not Approved",
  },
  roles: {

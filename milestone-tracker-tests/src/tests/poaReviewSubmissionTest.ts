...
const fillAndResubmit = (
  ...
  milestonePage.startPoAReviewResubmission(milestoneId)
...
const poaReviewSubmissionTest: NightwatchTests = {
  ...
  'CT 1 PoA Review submission'(browser: NightwatchBrowser) {
    ...
    goCantSubmit(browser, 900002, 5, 'challenge-team-1')
  },
  'CT 2 PoA Review submission'(browser: NightwatchBrowser) {
    ...
    goCantSubmit(browser, 900003, 5, 'challenge-team-2')
  },
  'IO PoA Review submission'(browser: NightwatchBrowser) {
    fillAndResubmit(browser, 900002, 2, 'iog')
    fillAndResubmit(browser, 900003, 2, 'iog')
  ...
  'Proposer 2 notifications'(this: NightwatchTests, browser: NightwatchBrowser) {
    checkNotifications(browser, 'proposer-2', this.count, '@poaReviewsNotifications', 2)
    checkNotifications(browser, 'proposer-1', this.count, '@poaReviewsNotifications', 2)
  },
